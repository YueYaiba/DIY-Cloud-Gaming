...
You device can now connect to the raspberry, and at this point, the setup is already complete (refer to the example command in the next session) , but we are gonna make it a bit more smooth.
